...
2. `config/plugin/template/ios/MyFirstRNApp/PersonalAccount.xcconfig.template` を `config/plugin/template/ios/MyFirstRNApp/PersonalAccount.xcconfig` としてコピーしてください。
